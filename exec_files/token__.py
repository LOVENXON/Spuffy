...
def validate_jwt(token_, uuid_client_param):
    try:
        decoded = jwt.decode(token_, cod_bagay_la, algorithms=["HS256"])
...
if __name__ == '__main__':
    ...
    token = generate_jwt("usuario", "usuario@example.com", my_uuid__, days_valid=3, subscription='basic')
    print(f"Token: {token}")
